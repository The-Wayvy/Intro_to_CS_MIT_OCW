...
def compute_deriv(poly):
    ...
    """
    derivative = ()
    for exponent in range(1,len(poly)):
        derivative = derivative + (exponent*poly[exponent],)
    return derivative
...
if __name__ == "__main__":
    ...
    print compute_root((-13.39, 0.0, 17.5, 3.0, 1.0),0.1,.0001) == (0.80679075379635201, 8.0)
'''
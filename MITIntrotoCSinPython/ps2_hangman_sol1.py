...
def load_words():
    ...
    wordlist = string.split(line) # Takes a string, returns a split up list.
...
def choose_word(wordlist):
    ...
    """
    return random.choice(wordlist) # Returns a random element of a sequence
...
def hangman():
    ...
    while num_guesses > 0 and not word_guessed:
        ...
        print 'Available letters: ' + ''.join(available_letters) # returns str

# Imitation dictionary. A list/tuple of ordered pair lists/tuples.
##def keySearch(L, k):
##    for elem in L:
...
##    else:
##        return word
# Assumes first and last characters are not spaces.
# If words have >1 space inbtwn then translation will have extra spaces.
##    
